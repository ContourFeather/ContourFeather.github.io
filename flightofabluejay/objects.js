placeObjects = function(){
    ...
    world.TreeBranch = function(x, y, i){
        ...
        this.radius = random(200, world.maxTreeBranchLength);
    ...
    world.Tree.prototype.draw = function(){
        stroke(lerpColor(this.color, color(0), world.darkness / 255));
    ...
    world.nest.draw = function(){
        ...
        rotate(theta)
        if(jay.inNest){
            image(images.jaySprite[jay.direction], 0, 0, 100, 100);
        }
